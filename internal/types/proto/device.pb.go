...
type Device struct {
	...
	Provider      Clipboard              `protobuf:"varint,4,opt,name=Provider,proto3,enum=belphegor.Clipboard" json:"Provider,omitempty"`
...
func (x *Device) GetProvider() Clipboard {
	if x != nil {
		return x.Provider
	}
...
const file_device_proto_rawDesc = "" +
	"\n" +
	"\fdevice.proto\x12\tbelphegor\"r\n" +
	"\x06Device\x12\x12\n" +
	"\x04Name\x18\x01 \x01(\tR\x04Name\x12\x12\n" +
	"\x04Arch\x18\x02 \x01(\tR\x04Arch\x12\x0e\n" +
	"\x02ID\x18\x03 \x01(\x03R\x02ID\x120\n" +
	"\bProvider\x18\x04 \x01(\x0e2\x14.belphegor.ClipboardR\bProvider*\\\n" +
	"\tClipboard\x12\b\n" +
	"\x04NULL\x10\x00\x12\t\n" +
...
var file_device_proto_depIdxs = []int32{
	0, // 0: belphegor.Device.Provider:type_name -> belphegor.Clipboard
